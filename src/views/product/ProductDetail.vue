<template>
  <div class="product-detail">
    <el-card>
      ...
      <el-form ref="formRef" :model="formData" :rules="rules" label-width="120px" :disabled="isViewMode">
        <!-- 基本信息 -->
        ...
        <el-form-item label="商品主图" prop="ProductImage">
          <el-upload action="/api/upload/product-image" :show-file-list="false" :on-success="handleImageSuccess"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="当前售价" prop="CurrentPrice">
              <el-input-number v-model="formData.CurrentPrice" :min="0" :precision="2" style="width: 100%;" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-form-item label="商品详情" prop="ProductContent">
          <RichTextEditor v-model="formData.ProductContent" :disabled="isViewMode" />
        </el-form-item>
